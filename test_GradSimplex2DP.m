function [dmodedr, dmodeds] = test_GradSimplex2DP(a,b,id,jd)
...
fa = JacobiP(a, 0, 0, id);     dfa = test_GradJacobiP(a, 0, 0, id);
gb = JacobiP(b, 2*id+1,0, jd); dgb = test_GradJacobiP(b, 2*id+1,0, jd);
% r-derivative
